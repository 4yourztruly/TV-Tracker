...
import { isEpisodeWatched, isSeasonFullyWatched, getNextEpisode } from '../utils/progress';
...
export function SeasonAccordion({ show, season, onToggleEpisode, onToggleSeason }: Props) {
